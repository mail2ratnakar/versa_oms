...
STATUS_ACTION = {
 ...
 "under_review": ("start_review","write"), "resolved": ("resolve","write"), "accepted": ("accept","approve"),
 "retired": ("retire","write"), "reopened": ("reopen","write"), "escalated": ("escalate","write"), "applied": ("apply","approve"),
