...
ROBOTS = ["derive_specs","derive_canonical","derive_catalog","derive_annotations","derive_5w1h","gen_db","gen_services","gen_routes","gen_rules","gen_screens","gen_portal","gen_fixtures","gen_annotate","gen_manifest"]
def main():
    for r in ROBOTS:
