...
function toggleMore(){{const m=document.getElementById('kpimore'),b=document.getElementById('moreBtn').querySelector('span');const open=m.style.display!=='none';m.style.display=open?'none':'flex';b.textContent=open?'See more':'See less';}}
loadKpis();"""
        return body, script
    if shape == "register":
