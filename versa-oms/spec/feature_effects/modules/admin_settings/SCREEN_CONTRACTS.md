# Admin Settings — Screen Contracts

## SCR-053 — Admin Settings List
...
## SCR-054 — Admin Settings Detail

- Route: `/staff/admin-settings/[id]`
- Kind: `detail`
...
## SCR-055 — Admin Settings Action

- Route: `/staff/admin-settings/[id]/actions/[action]`
- Kind: `action`
