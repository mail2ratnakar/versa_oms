# Student Roster Ops — Screen Contracts

## SCR-016 — Student Roster Ops List

- Route: `/staff/student-roster-ops`
- Kind: `list`
...
## SCR-017 — Student Roster Ops Detail

- Route: `/staff/student-roster-ops/[id]`
- Kind: `detail`
...
## SCR-018 — Student Roster Ops Action

- Route: `/staff/student-roster-ops/[id]/actions/[action]`
- Kind: `action`
