# Evaluation Ops — Screen Contracts

## SCR-031 — Evaluation Ops List

- Route: `/staff/evaluation-ops`
- Kind: `list`
...
## SCR-032 — Evaluation Ops Detail

- Route: `/staff/evaluation-ops/[id]`
- Kind: `detail`
...
## SCR-033 — Evaluation Ops Action

- Route: `/staff/evaluation-ops/[id]/actions/[action]`
- Kind: `action`
