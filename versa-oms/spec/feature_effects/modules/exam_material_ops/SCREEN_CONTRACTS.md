# Exam Material Ops — Screen Contracts

## SCR-025 — Exam Material Ops List

- Route: `/staff/exam-material-ops`
- Kind: `list`
...
## SCR-026 — Exam Material Ops Detail

- Route: `/staff/exam-material-ops/[id]`
- Kind: `detail`
...
## SCR-027 — Exam Material Ops Action

- Route: `/staff/exam-material-ops/[id]/actions/[action]`
- Kind: `action`
