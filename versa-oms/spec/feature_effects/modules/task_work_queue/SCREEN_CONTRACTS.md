# Task Work Queue — Screen Contracts

## SCR-046 — Task Work Queue List

- Route: `/staff/task-work-queue`
- Kind: `list`
...
## SCR-047 — Task Work Queue Detail

- Route: `/staff/task-work-queue/[id]`
- Kind: `detail`
...
## SCR-048 — Task Work Queue Action

- Route: `/staff/task-work-queue/[id]/actions/[action]`
- Kind: `action`
