# Roles & Permissions — Screen Contracts

## SCR-006 — Roles & Permissions List
...
## SCR-007 — Roles & Permissions Detail

- Route: `/staff/roles-permissions/[id]`
- Kind: `detail`
...
## SCR-008 — Roles & Permissions Action

- Route: `/staff/roles-permissions/[id]/actions/[action]`
- Kind: `action`
