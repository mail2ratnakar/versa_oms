...
- Counts are `it()` blocks per file. Totals: **24 files / 151 tests** (unit) + journey suite (as of 2026-06-24).
...
| child_write.test.ts | 4 | FR-0004 addChildRecord/reviewChildRecord: add+review child, mass-assignment-safe, audited | ✅ |
