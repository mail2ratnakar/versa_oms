...
Verification: `tsc` (0 err) + **242 vitest** + **46 Playwright journeys** (live Supabase; 45 passed + 1 auth-skip, no failures) + drift guardrail + `check_unique_constraints.py` (now also catches shadow-composite uniques) — all green. Migrations 0001–0028.
