...
Verification: `tsc` (0 err) + **253 vitest** + **53 Playwright journeys** (live Supabase; 52 passed + 1 auth-skip, no failures) + drift guardrail + `check_unique_constraints.py` + `check_workflows.py` (workflow-at-a-time tracker, **16/16 chains built**) — all green. Migrations 0001–0028.
