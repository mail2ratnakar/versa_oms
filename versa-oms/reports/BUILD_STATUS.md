...
Verification: `tsc` (0 err) + **249 vitest** + **47 Playwright journeys** (live Supabase; 46 passed + 1 auth-skip, no failures) + drift guardrail + `check_unique_constraints.py` (now also catches shadow-composite uniques) — all green. Migrations 0001–0028.
