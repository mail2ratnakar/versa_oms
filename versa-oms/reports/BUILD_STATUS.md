...
Verification: `tsc` (0 err) + **253 vitest** + **48 Playwright journeys** (live Supabase; 47 passed + 1 auth-skip, no failures) + drift guardrail + `check_unique_constraints.py` (now also catches shadow-composite uniques) — all green. Migrations 0001–0028.
