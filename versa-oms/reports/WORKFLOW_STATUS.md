...
| 6 | `WF-006` Courier Dispatch to Receipt | [ ] planned | 5 | 0/0 | WF-005 |
...
| 16 | `WF-016` Full Olympiad Operations Happy Path | [ ] planned | 14 | 0/0 | WF-001, WF-002, WF-003, WF-004, WF-005, WF-006, WF-007, WF-008, WF-009 |

**10/16 workflows built (or covered by built deps).** Next chain to build: `WF-006` Courier Dispatch to Receipt.
