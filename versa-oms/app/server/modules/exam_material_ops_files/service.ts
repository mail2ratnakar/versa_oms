...
export const {
  ...
  codeColumn: "file_code",
  codePrefix: "FILE",
  listConfig: {"filterColumns": ["file_status", "file_type"], "searchColumns": ["file_code"], "sortColumns": ["created_at", "file_status"], "defaultSort": {"column": "created_at", "ascending": false}, "facetColumn": "file_status", "facetValues": ["generated", "approved", "released", "revoked", "superseded", "archived"]},
  createSchema,
});
