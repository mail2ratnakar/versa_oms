...
export const {
  ...
  transitions: {"issue": {"target": "issued", "klass": "write", "reasonRequired": true, "dualApproval": false}, "mark_partially_paid": {"target": "partially_paid", "klass": "write", "reasonRequired": true, "dualApproval": false}, "mark_paid": {"target": "paid", "klass": "approve", "reasonRequired": true, "dualApproval": true}, "cancel": {"target": "cancelled", "klass": "write", "reasonRequired": true, "dualApproval": false}, "void": {"target": "voided", "klass": "approve", "reasonRequired": true, "dualApproval": true}, "supersede": {"target": "superseded", "klass": "approve", "reasonRequired": true, "dualApproval": true}},
