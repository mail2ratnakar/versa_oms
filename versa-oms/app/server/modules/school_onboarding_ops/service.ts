...
export const {
  ...
  listConfig: {"filterColumns": ["onboarding_status", "source_type", "duplicate_check_status"], "searchColumns": ["onboarding_code", "school_name", "city", "coordinator_name", "coordinator_email", "coordinator_phone"], "sortColumns": ["created_at", "onboarding_status", "updated_at"], "defaultSort": {"column": "created_at", "ascending": false}, "facetColumn": "onboarding_status", "facetValues": ["draft", "submitted", "under_review", "needs_more_info", "approved", "rejected", "activated", "blocked", "suspended", "archived"]},
  createSchema,
});
