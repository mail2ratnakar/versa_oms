...
export const {
  ...
  scope: "staff",
  statusColumn: "status",
  policy: {"read": ["certificate_admin", "operations_staff", "public", "school_coordinator", "system_admin"], "write": ["certificate_admin", "system_admin"], "export": ["certificate_admin"], "download": ["certificate_admin", "school_coordinator", "system_admin"]},
