...
export const {
  ...
  codeColumn: "answer_key_code",
  codePrefix: "ANSWER",
  listConfig: {"filterColumns": ["key_status"], "searchColumns": ["answer_key_code", "subject_code", "grade_code", "paper_set_code"], "sortColumns": ["created_at", "key_status", "updated_at"], "defaultSort": {"column": "created_at", "ascending": false}, "facetColumn": "key_status", "facetValues": ["draft", "under_review", "approved", "final", "superseded", "revoked", "archived"]},
  createSchema,
});
