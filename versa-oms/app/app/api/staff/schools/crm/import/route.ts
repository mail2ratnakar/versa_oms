...
export async function POST(request: NextRequest) {
  ...
  let body: { leads?: Array<Record<string, unknown>>; import_format?: string; default_lead_owner_id?: string } = {};
  ...
  try {
    const res = await importLeads(guard.actor, body.leads, { import_format: body.import_format, default_lead_owner_id: body.default_lead_owner_id });
