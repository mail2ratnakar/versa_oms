...
export async function GET(request: NextRequest, ctx: { params: Promise<{ id: string }> }) {
  ...
  return NextResponse.json(ok(await listChildRecords("school_status_controls", "onboarding_case_id", id, guard.actor), meta(guard.requestId, "school_onboarding_ops")));
}
