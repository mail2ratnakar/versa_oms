...
export default function Page() {
  return (
    <ModuleTable
      ...
      actions={[{"action": "validate", "label": "Validate", "variant": "light"}, {"action": "submit_for_lock", "label": "Submit for lock", "variant": "light"}, {"action": "lock", "label": "Lock", "variant": "blue"}, {"action": "archive", "label": "Archive", "variant": "light", "reason": true, "danger": true}]}
