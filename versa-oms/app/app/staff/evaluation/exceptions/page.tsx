...
export default function Page() {
  return (
    <ModuleTable
      ...
      description="Manage and review evaluation exceptions across the olympiad operations."
      breadcrumbs={[{"label": "Staff", "href": "/staff/dashboard"}, {"label": "Evaluation", "href": "/staff/evaluation"}, {"label": "Exceptions"}]}
      nextAction="\u2192 Use \u201cNew Evaluation Exception\u201d to add one, then act on it from the list."
