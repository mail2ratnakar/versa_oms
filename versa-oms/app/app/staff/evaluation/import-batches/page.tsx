...
export default function Page() {
  return (
    <ModuleTable
      ...
      detailPanels={[{"key": "candidate-responses", "label": "Candidate Responses", "subPath": "candidate-responses", "listColumns": ["response_status", "response_payload", "parser_confidence", "created_at"]}, {"key": "score-batches", "label": "Score Batches", "subPath": "score-batches", "listColumns": ["score_batch_status", "score_batch_code", "score_formula_version", "candidate_count"]}, {"key": "exceptions", "label": "Exceptions", "subPath": "exceptions", "listColumns": ["exception_status", "exception_code", "exception_type", "severity"]}]}
