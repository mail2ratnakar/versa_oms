...
export default function Page() {
  return (
    <ModuleTable
      ...
      columns={[{"key": "case_code", "label": "Case Code"}, {"key": "case_title", "label": "Case Title"}, {"key": "case_summary", "label": "Case Summary"}, {"key": "findings_summary", "label": "Findings Summary"}, {"key": "case_status", "label": "Status"}]}
