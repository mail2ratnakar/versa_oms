...
export default function Page() {
  return (
    <ModuleTable
      ...
      description="Manage and review security incidents across the olympiad operations."
      breadcrumbs={[{"label": "Staff", "href": "/staff/dashboard"}, {"label": "Security Audit", "href": "/staff/security-audit"}, {"label": "Incidents"}]}
      nextAction="\u2192 Use \u201cNew Security Incident\u201d to add one, then act on it from the list."
      statusKey="status"
