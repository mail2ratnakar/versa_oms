...
export default function Page() {
  return (
    <ModuleTable
      ...
      actions={[{"action": "submit", "label": "Submit", "variant": "light"}, {"action": "approve", "label": "Approve", "variant": "blue", "reason": true}, {"action": "reject", "label": "Reject", "variant": "light", "reason": true, "danger": true}, {"action": "activate", "label": "Activate", "variant": "blue"}, {"action": "block", "label": "Block", "variant": "light", "reason": true, "danger": true}, {"action": "suspend", "label": "Suspend", "variant": "light", "reason": true, "danger": true}, {"action": "archive", "label": "Archive", "variant": "light", "reason": true, "danger": true}]}
      detailPanels={[{"key": "documents", "label": "Documents", "subPath": "documents", "listColumns": ["review_status", "document_type", "review_note", "reviewed_at"]}, {"key": "events", "label": "Events", "subPath": "events", "listColumns": ["event_code", "previous_status", "new_status", "reason"]}, {"key": "status-controls", "label": "Status Controls", "subPath": "status-controls", "listColumns": ["control_status", "control_type", "reason", "applied_at"]}]}
