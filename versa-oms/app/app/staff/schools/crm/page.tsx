...
export default function Page() {
  return (
    <ModuleTable
      ...
      createFields={[{"key": "school_name", "label": "School name", "required": true}, {"key": "city", "label": "City", "required": true}, {"key": "state", "label": "State", "required": true}, {"key": "country", "label": "Country", "type": "select", "required": true, "default": "India", "options": ["India", "United Arab Emirates", "Saudi Arabia", "Qatar", "Oman", "Kuwait", "Bahrain", "Singapore", "Nepal", "Bhutan", "Sri Lanka", "Other"]}, {"key": "lead_source", "label": "Lead source", "type": "select", "required": true, "options": ["manual", "csv_import", "xlsx_import", "website", "referral", "event", "social", "email_campaign", "partner", "other"]}, {"key": "board", "label": "Board", "type": "select", "options": ["CBSE", "ICSE", "State Board", "Cambridge", "IB", "Other"]}, {"key": "coordinator_name", "label": "Coordinator name"}, {"key": "email", "label": "Email"}, {"key": "phone", "label": "Phone"}, {"key": "expected_student_count", "label": "Expected students", "type": "number"}]}
