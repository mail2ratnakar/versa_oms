...
export default function Page() {
  return (
    <ModuleTable
      ...
      description="Manage and review assignment scopes across the olympiad operations."
      breadcrumbs={[{"label": "Staff", "href": "/staff/dashboard"}, {"label": "Admin", "href": "/staff/admin"}, {"label": "Users", "href": "/staff/admin/users"}, {"label": "Assignment Scopes"}]}
      nextAction="\u2192 Use \u201cNew Assignment Scope\u201d to add one, then act on it from the list."
