...
export default function Page() {
  return (
    <ModuleTable
      ...
      description="Manage and review role change requests across the olympiad operations."
      breadcrumbs={[{"label": "Staff", "href": "/staff/dashboard"}, {"label": "Admin", "href": "/staff/admin"}, {"label": "Roles", "href": "/staff/admin/roles"}, {"label": "Change Requests"}]}
      nextAction="\u2192 Use \u201cNew Role Change Request\u201d to add one, then act on it from the list."
      statusKey="status"
