...
export default function Page() {
  return (
    <ModuleTable
      ...
      description="Define roles and the permissions that govern what each can do."
      breadcrumbs={[{"label": "Staff", "href": "/staff/dashboard"}, {"label": "Admin", "href": "/staff/admin"}, {"label": "Roles"}]}
      nextAction="\u2192 Use \u201cNew Roles & Permission\u201d to add one, then act on it from the list."
