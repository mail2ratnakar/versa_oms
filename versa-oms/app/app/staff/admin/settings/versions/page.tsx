...
export default function Page() {
  return (
    <ModuleTable
      ...
      createFields={[{ key: "setting_key", label: "Setting Key" }, { key: "setting_version", label: "Setting Version" }, { key: "setting_value", label: "Setting Value" }]}
      actions={[{"action": "approve", "label": "Approve", "variant": "blue", "reason": true}, {"action": "schedule", "label": "Schedule", "variant": "light"}, {"action": "reject", "label": "Reject", "variant": "light", "reason": true, "danger": true}, {"action": "archive", "label": "Archive", "variant": "light", "reason": true, "danger": true}]}
