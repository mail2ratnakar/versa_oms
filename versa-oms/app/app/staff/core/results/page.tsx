...
export default function Page() {
  return (
    <ModuleTable
      ...
      description="Manage and review results (core) across the olympiad operations."
      breadcrumbs={[{"label": "Staff", "href": "/staff/dashboard"}, {"label": "Core", "href": "/staff/core"}, {"label": "Results"}]}
      nextAction="\u2192 Use \u201cNew Results (core)\u201d to add one, then act on it from the list."
      statusKey="status"
      moduleId="results"
