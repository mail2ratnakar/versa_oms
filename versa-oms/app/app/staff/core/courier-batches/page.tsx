...
export default function Page() {
  return (
    <ModuleTable
      ...
      actions={[{"action": "dispatch", "label": "Dispatch", "variant": "light"}, {"action": "mark_in_transit", "label": "Mark in transit", "variant": "light"}, {"action": "deliver", "label": "Deliver", "variant": "light"}, {"action": "receive", "label": "Receive", "variant": "light"}, {"action": "close", "label": "Close", "variant": "light"}]}
    />
  );
}
