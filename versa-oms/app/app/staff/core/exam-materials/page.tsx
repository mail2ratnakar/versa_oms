...
export default function Page() {
  return (
    <ModuleTable
      ...
      description="Manage and review exam materials (core) across the olympiad operations."
      breadcrumbs={[{"label": "Staff", "href": "/staff/dashboard"}, {"label": "Core", "href": "/staff/core"}, {"label": "Exam Materials"}]}
      nextAction="\u2192 Use \u201cNew Exam materials (core)\u201d to add one, then act on it from the list."
      statusKey="status"
