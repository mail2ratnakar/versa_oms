...
export default function Page() {
  return (
    <ModuleTable
      ...
      description="Manage and review result publications across the olympiad operations."
      breadcrumbs={[{"label": "Staff", "href": "/staff/dashboard"}, {"label": "Results", "href": "/staff/results"}, {"label": "Publications"}]}
      nextAction="\u2192 Use \u201cNew Result Publication\u201d to add one, then act on it from the list."
      statusKey="status"
