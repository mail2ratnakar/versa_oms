...
export default function Page() {
  return (
    <ModuleTable
      ...
      description="Pick up and complete operational tasks across the platform."
      breadcrumbs={[{"label": "Staff", "href": "/staff/dashboard"}, {"label": "Tasks"}]}
      nextAction="\u2192 Use \u201cNew Task Queue\u201d to add one, then act on it from the list."
