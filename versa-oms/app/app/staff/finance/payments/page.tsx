...
export default function Page() {
  return (
    <ModuleTable
      ...
      breadcrumbs={[{"label": "Staff", "href": "/staff/dashboard"}, {"label": "Finance", "href": "/staff/finance"}, {"label": "Payments"}]}
      nextAction="\u2192 Use \u201cNew Payment\u201d to add one, then act on it from the list."
